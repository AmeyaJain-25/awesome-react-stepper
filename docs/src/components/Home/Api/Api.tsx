  ...
  return (
    <Section title="API">
      ...
      <p className={apiCss.contentDesc}>
        ...
        a progress bar highlighting the current active step. Below the progress
        bar the active step component is rendered. The order of steps will be as
        same as the order of children in <code>Stepper</code>.
      </p>
